...
<html>
  <head>
    ...
    <meta name="author" content="Muji Najarudin" />
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        <img style="margin-top:-12px" src="assets/img/logo-blue.png" alt="Logo" height="50"> <b>Klinik Giri Medika</b>
      </div><!-- /.login-logo -->
      <?php  
      ...
      <div class="login-box-body">
        ...
        <form action="login-check.php" method="POST">
          ...
          <div class="row">
            ...
            <br><center><p>Repost by <a href='#' title='MujiNajarudin' target='_blank'>Muji Najarudin</a></p></center>
