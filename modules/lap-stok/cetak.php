...
$query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,harga_beli,harga_jual,satuan,exp_date,stok FROM is_obat ORDER BY nama_obat ASC")
    ...
    <body>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">EXP.DATE</th>
                    </tr>
                </thead>
                <tbody>
        <?php
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='140' height='13' valign='middle'>$data[nama_obat]</td>
                        ...
                        <td width='70' height='13' align='center' valign='middle'>$data[exp_date]</td>
                    </tr>";
            $no++;
        }
        ?>  
