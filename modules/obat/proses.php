...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $exp_date   = mysqli_real_escape_string($mysqli, trim($_POST['exp_date']));

            $created_user = $_SESSION['id_user'];

            // perintah query untuk menyimpan data ke tabel obat
            $query = mysqli_query($mysqli, "INSERT INTO is_obat(kode_obat,nama_obat,harga_beli,harga_jual,satuan,exp_date,created_user,updated_user) 
                                            VALUES('$kode_obat','$nama_obat','$harga_beli','$harga_jual','$satuan','$exp_date','$created_user','$created_user')")
