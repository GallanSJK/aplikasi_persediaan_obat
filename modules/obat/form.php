          ...
          <form role="form" class="form-horizontal" action="modules/obat/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="date" class="form-control" name="exp_date" autocomplete="off" required>
                </div>
              </div>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT kode_obat,nama_obat,harga_beli,harga_jual,satuan,exp_date FROM is_obat WHERE kode_obat='$_GET[id]'") 
          ...
          <form role="form" class="form-horizontal" action="modules/obat/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Tanggal Kadaluarsa</label>
                <div class="col-sm-5">
                  <input type="date" class="form-control" name="exp_date" autocomplete="off" value="<?php echo $data['exp_date']; ?>" required>
                </div>
              </div>
