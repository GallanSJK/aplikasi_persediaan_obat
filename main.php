    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:17px">Klinik Giri Medika</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="#">Klinik Giri Medika</a>.</strong> | Repost by <a href='#' title='MujiNajarudin' target='_blank'>Muji Najarudin</a>
