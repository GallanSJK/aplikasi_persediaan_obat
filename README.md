...
# Fitur Apilkasi
1. Login,
Halaman login multi user. Ada 3 level user yaitu Super Admin, Manajer dan Apoteker.
2. Data Obat,
...
3. Data Obat Keluar,
Halaman untuk mengolah data obat masuk. Pada halaman ini user dapat menginput, dan mencari data obat keluar.
4. Laporan Stok Obat,
...
Sumber/Collaborate : https://github.com/indrasatya/
